...
HANDLE Screen::getStdinHandle() const {
    return stdinHandle;
}
...
HandleHolder Screen::createBuffer(SHORT width, SHORT height) {
    HandleHolder buffer = CreateConsoleScreenBuffer(GENERIC_READ | GENERIC_WRITE, 0, nullptr, CONSOLE_TEXTMODE_BUFFER, nullptr);
